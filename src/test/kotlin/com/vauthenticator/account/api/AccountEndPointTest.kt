...
internal class AccountEndPointTest {
    ...
    internal fun `sign up a new account`() {
        ...
        val masterAccount = com.vauthenticator.account.AccountTestFixture.anAccount().copy(accountNonExpired = true, emailVerified = false, accountNonLocked = false, credentialsNonExpired = true, enabled = false,)
    ...
    internal fun `update account details`() {
        val representation = FinalAccountRepresentation(email = "email@domain.com", password = "secret", firstName = "A First Name", lastName = "A Last Name", authorities = emptyList(), birthDate = "", phone = Phone.nullValue().formattedPhone())
        val masterAccount = com.vauthenticator.account.AccountTestFixture.anAccount().copy(accountNonExpired = true, emailVerified = true, accountNonLocked = true, credentialsNonExpired = true, enabled = true,)
        val clientAppId = "A_CLIENT_APP_ID"
