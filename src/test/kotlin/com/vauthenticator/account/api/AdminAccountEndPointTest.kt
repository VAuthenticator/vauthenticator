...
internal class AdminAccountEndPointTest {
    ...
    internal fun `find all accounts`() {
        ...
        val masterAccount = com.vauthenticator.account.AccountTestFixture.anAccount()
    ...
    internal fun `set an account as disabled`() {
        ...
        val masterAccount = com.vauthenticator.account.AccountTestFixture.anAccount().copy(enabled = false)

        given(accountRepository.accountFor("anemain@domain.com"))
                .willReturn(Optional.of(com.vauthenticator.account.AccountTestFixture.anAccount()))
