...
class MailServiceConfig {
    ...
    fun mailSenderService(javaMailSender: JavaMailSender, documentRepository: DocumentRepository) : MailSenderService =
            JavaMailSenderService(documentRepository, javaMailSender)
