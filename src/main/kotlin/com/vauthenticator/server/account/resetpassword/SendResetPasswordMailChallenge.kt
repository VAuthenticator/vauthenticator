...
class SendResetPasswordMailChallenge(
    ...
    fun authenticatedSendResetPasswordMail(mail: String, principal: JwtAuthenticationToken) {
        if (principal.hasEnoughScopes(Scope.RESET_PASSWORD)) {
            ...
            throw InsufficientClientApplicationScopeException("The client app ${principal.clientAppId().content} does not support reset-password use case........ consider to add ${Scope.RESET_PASSWORD.content} as scope")
        }
    }
